UPDATE pixels SET name = 'METADATA.ome.xml', path = 'demo_2/2017-04/13/14-25-28.687_mkngff/dbb0682a-1330-4286-a5b7-803bd7eb4b26.zarr/OME' where image in (select id from Image where fileset = 23472);
