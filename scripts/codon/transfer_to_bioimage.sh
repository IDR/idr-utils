# !/bin/bash
# Submit a SLURM job to transfer data from the private data services onto NFS bioimage
#
# Usage: ./transfer_to_bioimage.sh <folder>
#
# <folder> should be an existing subfolder of /nfs/ftp/private/idr-transfer/upload
#
...
# ./transfer_to_bioimage.sh idr0088-cox-phenomicprofiling
#
# For larger studies, the script also supports partial transfer of subfolders e.g.
# ./transfer_to_bioimage.sh idr0043-uhlen-humanproteinatlas/20181112-ftp
#
...
mpirun -np 8 dsync -v --progress 1 /nfs/ftp/private/idr-transfer/upload/$1/ /nfs/ebi/bioimage/drop/$1/
find /nfs/ebi/bioimage/drop/$1/ -type f -exec chmod 644 {} \;
find /nfs/ebi/bioimage/drop/$1/ -type d -exec chmod 755 {} \;
EOT
